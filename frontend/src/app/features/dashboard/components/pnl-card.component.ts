...
@Component({
  ...
  template: `
    <div class="card metric-card">
      ...
      <div class="metric-subrow">
        ...
        <span
          class="metric-pnl"
          [ngClass]="(summary()?.daily_realized_pnl ?? 0) >= 0 ? 'positive' : 'negative'"
        >
  ...
  styles: [`
    ...
    .metric-subrow { display: flex; justify-content: space-between; align-items: center; }
    .metric-pnl { font-weight: 600; }
